									...
									$bigstring = '<div class="col-sm-12 col-md-12 col-lg-12">
													<div class="card" style="background: linear-gradient(to top, #faa41a 40%, rgba(255,255,255,.6)), url('.$picurl.');">
														<div class="card-body text-left">
															<h6 class="card-title text-uppercase font-weight-bold mt-0"><a href="../tootaja/kuulutus?c='.$validationcode.'">'.$heading.'</a></h6>
		    			...
		    			<form class="row <?php if ($form_success){ echo "hidden"; }?>" action="prax_api.php" method="post" enctype="multipart/form-data" id="form_student">
		    				...
		    				<div class="col-lg-8">
		    					...
		    					<div class="form-group">
									...
									<input type="text" 
									class="form-control <?php if(!empty($_POST) && !$removeing) { if($name == "") { echo "is-invalid"; } } ?>" 
									id="name" 
									name="name" 
									<?php echo "value='".htmlspecialchars($name)."'";?>>
